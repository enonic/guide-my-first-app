...
[NOTE]
====
The other folders and files in the project structure are not relevant for completing this tutorial.
====
...
image::images/app.png[My First app listed]
...
. *Test the webapp*. It should be available on http://localhost:8080/app/<name.of.your.app> You can also find the link from the admin Applications UI. If everything went well, it will look somethink like the screenshot below:
